...
function Index() {
  ...
  return (
    ...
    >
      ...
      {/* Pair header */}
      <div className="mx-1 mb-1 rounded-2xl bg-trade-card shadow-2xl overflow-hidden">
        {/* Top row */}
      ...
      {/* Main trading card */}
      <section className="mx-1 rounded-2xl bg-trade-card shadow-2xl px-5 pt-3 pb-5">
      ...
      {/* Bottom tabs */}
      <section className="mx-1 mt-1 rounded-2xl bg-trade-card shadow-2xl overflow-hidden">
